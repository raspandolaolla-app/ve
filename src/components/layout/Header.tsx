  ...
  return (
    <header id="app-header" className="bg-slate-950/90 border-b border-slate-800 sticky top-0 z-40 backdrop-blur-md">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            {state === 'loading' ? (
              ...
              <div className="flex items-center gap-2">
                <button
                  ...
                  className="flex items-center gap-2 px-3 py-1.5 rounded-xl bg-slate-900 border border-slate-800 hover:border-slate-700 transition-colors text-xs text-slate-200"
                >
        ...
        <div className="flex md:hidden items-center justify-around py-2 border-t border-slate-900 overflow-x-auto gap-1">
          <button
            id="mobile-nav-home"
            onClick={() => onNavigate('home')}
            className={`px-2.5 py-1 rounded-lg text-xs font-medium transition-colors flex items-center gap-1 shrink-0 ${
              currentTab === 'home'
                ? 'bg-amber-500/10 text-amber-400 border border-amber-500/30'
