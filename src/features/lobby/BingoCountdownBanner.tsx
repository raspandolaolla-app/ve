...
export const BingoLiveRoomCard: React.FC<BingoLiveRoomCardProps> = ({
  ...
  return (
    <div
      ...
      className={`relative overflow-hidden rounded-2xl border bg-gradient-to-b from-[#130E22] via-[#0A0815] to-[#080611] p-4 sm:p-5 transition-all duration-300 flex flex-col justify-between ${neonBorderClass}`}
    >
        ...
        <div className="flex items-start justify-between gap-3">
          <div>
            <div className="flex items-center gap-2">
              ...
              />
              <h3 className={`text-base sm:text-lg font-black uppercase tracking-wider bg-clip-text text-transparent bg-gradient-to-r ${neonTitleGradient}`}>
                {title}
              </h3>
            </div>
          ...
          {isTableActive ? (
            hasActiveCountdown ? (
              <span className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full bg-red-500/20 border border-red-500/40 text-[10px] font-black text-red-300 uppercase tracking-tight animate-pulse shadow-[0_0_10px_rgba(239,68,68,0.4)] shrink-0">
                <span className="w-2 h-2 rounded-full bg-red-400" />
                EN CONTEO
              </span>
            ) : (
              <span className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full bg-emerald-500/20 border border-emerald-500/40 text-[10px] font-black text-emerald-300 uppercase tracking-tight shadow-[0_0_10px_rgba(16,185,129,0.4)] shrink-0">
                <span className="w-2 h-2 rounded-full bg-emerald-400 animate-pulse" />
                SALA ABIERTA
              </span>
            )
          ) : (
            <span className="inline-flex items-center gap-1 px-2.5 py-1 rounded-full bg-slate-800/80 border border-slate-700 text-[10px] font-black text-slate-400 uppercase tracking-tight shrink-0">
              SIN MESA ACTIVA
            </span>
          )}
        </div>
      ...
      {isTableActive ? (
        <div className="relative z-10 flex flex-col gap-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 items-center">
            {/* Display LED Digital Agrandado */}
            <div className={`bg-[#05040B] border-2 rounded-2xl px-4 py-3 text-center flex flex-col items-center justify-center ${neonLedBorder}`}>
              ...
              <span className={`text-3xl sm:text-4xl lg:text-5xl font-mono font-black tracking-widest ${neonLedText}`}>
                {minutes}:{seconds}
              </span>
            ...
            <div className="bg-[#0B0915] border border-amber-500/40 rounded-2xl p-3 flex flex-col justify-between shadow-inner">
              ...
              <div className="my-1.5">
                <div className="text-2xl sm:text-3xl font-black font-mono text-white tracking-tight">
                  {netPrize.toFixed(2)}{' '}
                  <span className="text-xs sm:text-sm font-bold text-amber-400">Bs</span>
                </div>
              </div>
          ...
          <div className="grid grid-cols-3 gap-2 bg-[#090712]/80 border border-slate-800/80 rounded-xl p-2.5 text-center">
            <div>
          ...
          <button
            ...
            className={`w-full py-3 px-4 rounded-xl text-slate-950 font-black text-xs sm:text-sm uppercase tracking-wider transition-all transform active:scale-95 cursor-pointer flex items-center justify-center gap-2 ${buttonGradient}`}
          >
        ...
        /* ===================================================================== */
        <div className="relative z-10 flex flex-col justify-between gap-4 py-1">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 items-center">
            {/* Display Standby Agrandado */}
            <div className="bg-[#05040B] border-2 border-slate-800 rounded-2xl px-4 py-3 text-center flex flex-col items-center justify-center shadow-inner">
              <span className="text-[10px] uppercase tracking-widest text-slate-500 font-bold mb-0.5">
                Temporizador
              </span>
              <span className="text-3xl sm:text-4xl lg:text-5xl font-mono font-black tracking-widest text-slate-600">
                03:00
              </span>
              <span className="text-[9px] font-mono tracking-widest text-slate-500 mt-0.5">
                LISTO PARA INICIAR
            ...
            <div className="bg-[#0B0915] border border-slate-800 rounded-2xl p-3 flex flex-col justify-between">
              ...
              <span className="text-[10px] text-slate-500 font-medium">
                La cuenta regresiva de 3 min iniciará al haber 2 jugadores.
              </span>
            </div>
          </div>
          ...
          <button
            ...
            className="w-full py-3 px-4 rounded-xl bg-gradient-to-r from-purple-600 via-indigo-600 to-purple-700 hover:from-purple-500 hover:to-indigo-500 text-white font-black text-xs sm:text-sm uppercase tracking-wider transition-all transform active:scale-95 cursor-pointer flex items-center justify-center gap-2 shadow-[0_0_15px_rgba(147,51,234,0.35)]"
          >
